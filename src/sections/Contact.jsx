  ...
  return (
    <section id="contact" className="h-screen bg-gradient-to-b from-black via-black to-blue-500 flex flex-col items-center justify-center text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl w-full">
        ...
        {/* LinkedIn */}
        <a 
          href="https://www.linkedin.com/in/naveen166/" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="flex flex-col items-center p-6 bg-gray-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300" 
          data-aos="fade-left"
        >
          ...
          <p className="mt-2">naveen166</p>
        </a>
        <a 
          href="https://leetcode.com/u/naveen_166/" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="flex flex-col items-center p-6 bg-gray-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300" 
          data-aos="fade-left"
        >
          <img src={leetcode} alt="Leetcode" className="w-16 h-16 mb-4" />
